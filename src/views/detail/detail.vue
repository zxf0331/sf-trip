<template>
  <div class="detail top-page" ref="detailRef">
    ...
    <div class="main" v-if="mainPart" v-memo="[mainPart]">
      ...
      <detail-infos name="描述" :ref="getSectionRef" :top-info="mainPart.topModule"/>
...
import DetailInfos from "./cpns/detail_02-info.vue"
...
import ActionBar from "./cpns/detail_09-action-bar.vue"
