<template>
    <div class="search-list-item-info">
        <div class="tags">
            <template v-for="(item, index) in itemData.houseTags" :key="index" :style="{color: item.color}">
        ...
        <div class="price">
            ...
            <van-tag round color="rgb(251, 74, 74)" text-color="#fff">
...
// console.log("itemdata", props.itemData.priceTipBadge.text)
